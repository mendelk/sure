...
# lucide-settings 06 Settings Onboarding and Admin

Complete user, family, security, onboarding, hosting, and super-admin workflows, including destructive operations, through role-aware API contracts.
