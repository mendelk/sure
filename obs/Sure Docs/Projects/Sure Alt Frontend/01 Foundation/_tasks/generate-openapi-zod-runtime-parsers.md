...
- Use a pinned, maintained OpenAPI-to-Zod generator. Do not implement or retain a custom OpenAPI schema compiler; project-owned adapters may only index, compose, or invoke generated exports without reinterpreting schema semantics. Document the choice and derive or cross-check TypeScript types from the same OpenAPI source so generated static and runtime contracts cannot silently diverge.
